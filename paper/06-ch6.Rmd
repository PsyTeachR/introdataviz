...
```{r splitviolin, echo = FALSE, fig.cap = "Split-violin plot"}
...
```{r raincloud, echo = FALSE, fig.cap="Raincloud plot. The point and line in the centre of each cloud represents its mean and 95% CI. The rain respresents individual data points."}
rain_height <- .1
...
```{r ridgeplot, echo = FALSE, fig.cap="A ridge plot.", fig.width = 5, fig.height = 6}
...
```{r alluvial, echo = FALSE, fig.cap="An alluvial plot showing the progression of student grades through the years."}
library(ggalluvial)
...
```{r map, echo = FALSE, fig.cap = "Map coloured by country."}
