...
{\centering \includegraphics[width=0.8\linewidth]{images/layers-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/remove-layer-1} 
...
R Markdown is a dynamic format that allows you to combine text and code into one reproducible document. The R Markdown workbook available in the \href{https://osf.io/bj83f/files/}{online materials} contains all the code in this tutorial and there is more information and links to additional resources for how to use R Markdown for reproducible reports in the additional resources.
...
{\centering \includegraphics[width=0.8\linewidth]{images/bar1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/unnamed-chunk-8-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/bar-precalc-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/histogram1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/histogram2-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/histogram-fill-color-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/bar3-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/histogram-theme-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/histograms-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/density-rt-1} 
...
\FunctionTok{ggplot}\NormalTok{(dat\_long, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ rt, }\AttributeTok{fill =}\NormalTok{ condition)) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_fill\_discrete}\NormalTok{(}\AttributeTok{name =} \StringTok{"Condition"}\NormalTok{,}
                      \AttributeTok{labels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Non{-}Word"}\NormalTok{, }\StringTok{"Word"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{images/density-grouped-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/point-plot-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/smooth-plot-1} 
...
Similar to the density plot, the scatterplot can also be easily adjusted to display grouped data. For \texttt{geom\_point()}, the grouping variable is mapped to \texttt{colour} rather than \texttt{fill} and the relevant \texttt{scale\_*} function is added\footnote{Please note that the code and figure for this plot has been corrected from the published paper due to the labels ``Word'' and ``Non-word'' being incorrectly reversed. This is of course mortifying as authors, although it does provide a useful teachable moment that R will do what you tell it to do, no more, no less, regardless of whether what you tell it to do is wrong.}.
...
{\centering \includegraphics[width=0.8\linewidth]{images/scatter-grouped-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/unnamed-chunk-15-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/brewer-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/boxplot1-1} 
...
As with histograms and density plots, \texttt{fill} can be used to create grouped boxplots. This looks like a lot of complicated code at first glance, but most of it is just editing the axis labels\footnote{Please note that the code and figure for this plot has been corrected from the published paper due to the labels ``Word'' and ``Non-word'' being incorrectly reversed. This is of course mortifying as authors, although it does provide a useful teachable moment that R will do what you tell it to do, no more, no less, regardless of whether what you tell it to do is wrong.}.
...
\FunctionTok{ggplot}\NormalTok{(dat\_long, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ condition, }\AttributeTok{y =}\NormalTok{ acc, }\AttributeTok{fill =}\NormalTok{ language)) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_x\_discrete}\NormalTok{(}\AttributeTok{name =} \StringTok{"Condition"}\NormalTok{,}
                   \AttributeTok{labels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Non{-}Word"}\NormalTok{, }\StringTok{"Word"}\NormalTok{)) }\SpecialCharTok{+}
...
{\centering \includegraphics[width=0.8\linewidth]{images/boxplot3-1} 
...
Violin plots display the distribution of a dataset and can be created by calling \texttt{geom\_violin()}. They are so-called because the shape they make sometimes looks something like a violin. They are essentially sideways, mirrored density plots. Note that the below code is identical to the code used to draw the boxplots above, except for the call to \texttt{geom\_violin()} rather than \texttt{geom\_boxplot()}{[}\^{}ch4-3{]}.
...
{\centering \includegraphics[width=0.8\linewidth]{images/violin1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/badbar1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/badbar2-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/viobox1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/viobox1b-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/viobox2-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/viobox3-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/viobox6-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/viobox5-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/ixn-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/ixn-by-subj-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/scatterplot-facet-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/violin-boxplot-facet-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/violin-facet-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/patchwork-side-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/patchwork-stack-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/edited-labels-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/unnamed-chunk-22-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/splitviolin-1} 
...
\{\centering \includegraphics[width=0.8\linewidth]{images/raincloud-1}
...
{\centering \includegraphics[width=0.8\linewidth]{images/ridgeplot-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/alluvial-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/map-1} 
...
Barrett, T. S. (2019). \emph{Six reasons to consider using r in psychological research}.

\leavevmode\vadjust pre{\hypertarget{ref-NYT-R}{}}%
Bertini, E., \& Stefaner, M. (2015). Amanda cox on working with r, NYT projects, favorite data {[}podcast{]}. Retrieved from \url{https://datastori.es/ds-56-amanda-cox-nyt/}
...
Nation, Z. (2017). Perceptions. \url{https://github.com/zonination/perceptions\%20\%20}; GitHub.
...
Visual, B., \& Journalism, D. (2019). How the BBC visual and data journalism team works with graphics in r. Retrieved from \url{https://medium.com/bbc-visual-and-data-journalism/how-the-bbc-visual-and-data-journalism-team-works-with-graphics-in-r-ed0b35693535}
...
Wilkinson, L., Anand, A., \& Grossman, R. (2005). Graph-theoretic scagnostics. \emph{IEEE Symposium on Information Visualization (InfoVis 05)}, 157--158. IEEE Computer Society.

\leavevmode\vadjust pre{\hypertarget{ref-rminr}{}}%
Wills, A. (n.d.). Teaching research methods in r. Retrieved from \url{https://www.andywills.info/rminr/rminrinpsy.html}
