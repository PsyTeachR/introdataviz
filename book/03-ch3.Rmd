...
```{r point-plot, fig.cap="Point plot of reaction time versus age.", message = FALSE}
...
```{r scatter-grouped, warning = FALSE,fig.cap="Grouped scatter plot of reaction time versus age by condition.", message = FALSE}
...
```{r message = FALSE, fig.cap="Scatterplot with data grouped by langauge group"}
